...
const CreatePost = () => {
  // State to manage dynamic form switching
        ...
        <div className="create-post-container">
          ...
          <div className="create-post-form">
            <div className="form-card">
              ...
              <p>Fill in the property information below to list your property.</p>
          ...
          <div className="create-post-sidebar">
            ...
            <div className="upload-card">
              ...
              <p className="upload-helper">Required for admin verification.</p>
